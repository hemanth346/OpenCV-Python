...
parse.add_argument("-i","--image",help="Provide path to image")
...
def blur_track(val):
    ...
    cv2.putText(output, text, (20,20), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0,0,0), 1)
...
def thresh_track(val):
    ...
    cv2.putText(output, name, (20,20), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (192,234,123), 1)
...
def combined():
    ...
    cv2.imshow(title_window_combined, global_thresh)
...
cv2.namedWindow(title_window_thresh)
...
cv2.namedWindow(title_window_combined)
